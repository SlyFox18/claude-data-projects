...
- [ ] **Step 3: Leave the default "Title" column alone**

It's unused but SharePoint requires it to exist. No action needed.

- [ ] **Step 4: Note the site URL**
...
- [ ] **Step 7: Add it to Phase 1 of Pipeline_Master_Orchestrator**
...
- [ ] **Step 2: Insert "AuditLog" into PBI_QueryOrder, immediately before "Fact_ServiceTimeSheet_Audit"**
...
- [ ] **Step 3: Add a `ref table AuditLog` line immediately before `ref table Fact_ServiceTimeSheet_Audit`**
...
- [ ] **Step 1: Read the end of the file to find the exact insertion point and confirm current indentation**
...
- [ ] **Step 2: Insert these five columns**
...
- [ ] **Step 3: Verify no `//` comments were introduced**
...
- [ ] **Step 3: Spot-check with a DAX query**
...
- [ ] **Step 1: Insert the Power Apps visual**
...
- [ ] **Step 2: Add the fields the panel needs**
...
- [ ] **Step 3: Add the SharePoint list as a data source inside Power Apps Studio**
...
- [ ] **Step 5: Wire up `PowerBIIntegration.OnSelectionChanged`**
...
- [ ] **Step 7: Set the existing-audit status label**
...
- [ ] **Step 8: Pre-fill the note field with any existing note**

```
txtAuditNote.Default = If(IsBlank(varExistingAudit), "", varExistingAudit.AuditNote)
```

- [ ] **Step 9: Wire up the Save button**
...
- [ ] **Step 10: Save the Power Apps app**
...
- [ ] **Step 1: Position the Power Apps visual**
...
- [ ] **Step 2: Add the "Audited" column to the table**
...
- [ ] **Step 5: Verify the upsert (not append)**
...
- [ ] **Step 6: Verify the nightly sync path**
...
- [ ] **Step 7: Refresh the semantic model**
...
- [ ] **Step 8: Follow the established deployment workflow before going live**
