...
- **Status:** notebook and pipeline created and confirmed working in Fabric as of 2026-07-08 (Phase 2 of the implementation plan). Desktop model wiring is in progress — see `docs/superpowers/plans/2026-07-08-md-invoices-monthly-snapshot.md`, Task 8.
